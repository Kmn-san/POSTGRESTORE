...
function Register() {
  const {setAccount, account ,addUser,loading} = useAuthStore();
  ...
  return  (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 px-4">
      ...
      {/* Form Card */}
      <div className="bg-white shadow-md rounded-2xl p-8 w-full max-w-md flex flex-col items-center gap-2">
          ...
          <div className="w-full">
            <label className="input validator w-full flex items-center gap-2">
              ...
              <input
                ...
                onChange={(e) => setAccount({ ...account, confirmPass: e.target.value })}
              />
            </label>
          </div>
